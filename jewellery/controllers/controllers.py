...
class jewelleryProfileReq(http.Controller):
    ...
    def create_webpatient(self, **kw):
        ...
        request.env['jewellery.profile'].sudo().create(kw)
        vals = {
             'name': kw.get('jewellery_name'),
             'degree': kw.get('jewellery_degree')
         }
        return request.render("jewellery.form_response_1", {'form_1_details': kw})